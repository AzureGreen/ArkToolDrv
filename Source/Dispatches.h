...
//////////////////////////////////////////////////////////////////////////
#define IOCTL_KRNL_GET_KISERVICETABLE  (UINT32)CTL_CODE(FILE_DEVICE_UNKNOWN, 0x824, METHOD_NEITHER, FILE_READ_ACCESS | FILE_WRITE_ACCESS)
#define IOCTL_KRNL_ENUM_SSDTFUNCTION_LIST  (UINT32)CTL_CODE(FILE_DEVICE_UNKNOWN, 0x825, METHOD_NEITHER, FILE_READ_ACCESS | FILE_WRITE_ACCESS)
#define IOCTL_KRNL_RESUME_HOOKED_SSDTFUNCTION  (UINT32)CTL_CODE(FILE_DEVICE_UNKNOWN, 0x826, METHOD_NEITHER, FILE_READ_ACCESS | FILE_WRITE_ACCESS)
#define IOCTL_KRNL_GET_WIN32KSERIVCE  (UINT32)CTL_CODE(FILE_DEVICE_UNKNOWN, 0x827, METHOD_NEITHER, FILE_READ_ACCESS | FILE_WRITE_ACCESS)
#define IOCTL_KRNL_ENUM_SSSDTFUNCTION_LIST  (UINT32)CTL_CODE(FILE_DEVICE_UNKNOWN, 0x828, METHOD_NEITHER, FILE_READ_ACCESS | FILE_WRITE_ACCESS)
#define IOCTL_KRNL_ENUM_KRNLFILE  (UINT32)CTL_CODE(FILE_DEVICE_UNKNOWN, 0x829, METHOD_NEITHER, FILE_READ_ACCESS | FILE_WRITE_ACCESS)
#define IOCTL_KRNL_ENUM_KRNLIAT  (UINT32)CTL_CODE(FILE_DEVICE_UNKNOWN, 0x830, METHOD_NEITHER, FILE_READ_ACCESS | FILE_WRITE_ACCESS)
#define IOCTL_KRNL_ENUM_KRNLEAT  (UINT32)CTL_CODE(FILE_DEVICE_UNKNOWN, 0x831, METHOD_NEITHER, FILE_READ_ACCESS | FILE_WRITE_ACCESS)
